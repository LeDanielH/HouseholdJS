...
import {
	...
	HHParentProps,
	HHPetProps,
	HHWallProps, HHAssignType, HHSimpleProps, HHPositionedProps, HHSpacerProps, HHImageProps
...
export const HHParent: HHAssignType<HHParentProps, 'div'> = styled('div')<HHParentProps>(
	(props: HHParentProps): CSSObject => getHHParentStyles(props)
)

export const HHChild: HHAssignType<HHChildProps, 'div'> = styled('div')<HHChildProps>(
	(props: HHChildProps): CSSObject => getHHChildStyles(props)
)

export const HHGrandParent: HHAssignType<HHGrandparentProps, 'div'> = styled('div')<HHGrandparentProps>(
...
export const HHWall: HHAssignType<HHWallProps, 'div'> = styled('div')<HHWallProps>(
	(props: HHWallProps): CSSObject => getHHWallStyles(props)
)

export const HHSpacer: HHAssignType<HHSpacerProps, 'div'> = HHWall

export const HHWindow: HHAssignType<HHWindowProps, 'img'>  = styled('img')<HHWindowProps>(
