...
export type TProps = TPassedProps & Partial<SvgProps>;

// eslint-disable-next-line func-style
export const SvgNative = ({
							  size,
							  viewBoxWidth,
							  viewBoxHeight,
							  viewBoxSize,
	...
	const { width, height } = calculateSvgSize(vbWidthNumber, vbHeightNumber, size);
	...
	return (
		<svg
			...
			{...restProps}
		>
			<g fill="none" scaleY={overflowFixScaleRatio} scaleX={overflowFixScaleRatio}>
				<g
					translateX={overflowFixPosition}
					translateY={overflowFixPosition}
				>
					{children}
				</g>
			</g>
